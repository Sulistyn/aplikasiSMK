  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-user-edit mr-2"></i>UBAH DATA SISWA</h3><hr>
            
            <form action="" method="post">
            	<ul>
            		
						<input type="hidden" name="id" id="id" required value="<?=$swa["id"] ?>" >
					
					<li>
						<label for="nama">Nama : </label>
						<input type="text" class="form-control" name="nama" id="nama" required value="<?=$swa["nama"] ?>" >
					</li>
					<li>
						<label for="nis">NIS : </label>
						<input type="text" class="form-control" name="nis" id="nis" required value="<?=$swa["nis"] ?>" >
					</li>
					<li>
						<label for="ttl">Tempat Tanggal Lahir : </label>
						<input type="text" class="form-control" name="ttl" id="ttl" required value="<?=$swa["ttl"] ?>" >
					</li>
					<li>
						<label for="alamat">alamat : </label>
						<input type="text" class="form-control" name="alamat" id="alamat" required value="<?=$swa["alamat"] ?>" >
					</li>
					<li>
						<label for="gambar">gambar : </label>
						<input type="text" class="form-control" name="gambar" id="gambar" required value="<?=$swa["gambar"] ?>" >
					</li>
