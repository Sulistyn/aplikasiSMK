  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            TAMBAH DATA SISWA <i class="fas fa-plus-square mr-2"></i>
            </button>
                    ...
                    <form class="form-group" action="" method="post">
                      <ul>
                         <li><label for="nama">Nama lengkap</label></li>
                              <input type="text" name="nama" class="form-control" id="nama_lengkap" placeholder="masukan nama lengkap anda">
                          <li><label for="nis">NIS</label></li>
                              <input type="text" name="nis" class="form-control" id="nis" placeholder="masukan nis anda">
                          <li><label for="ttl">Tempat Tanggal Lahir</label></li>
                          ...
                          <li><label for="alamat">Alamat</label></li>
                              <input type="text" name="alamat" class="form-control" id="alamat" placeholder="masukan alamat anda"></li>
            ...
            <table class="table table-striped table-bordered text-center">
              ...
              <?php $i= 1; ?>
                ...
                <tr>
                  ...
                  <td><?= $swa["ttl"]; ?></td>
                  <td><?= $swa["alamat"]; ?></td>           
                  <td><a href="detail.php? id=<?= $swa["id"];?>" class="btn btn-primary mt-2 text-center">Detail</a></td>
                  <td><a href="ubah.php? id=<?= $swa["id"];?>" onclick= "return confirm('Apakah anda yakin ingin mengubah?')"><i class="fas fa-edit bg-info text-white p-2 rounded" data-toggle="tooltip" title="edit"></i></a></td>
                  <td><a href="hapus.php? id=<?= $swa["id"];?>" onclick= "return confirm('Apakah anda yakin ingin menghapus?')"><i class="fas fa-trash-alt bg-success text-white p-2 rounded" data-toggle="tooltip" title="Delete"></i></a></td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
            </table>
